        ...
        <div class="table-responsive col-sm-10">
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <%
                        com.LuoXiande.model.Order o=(com.LuoXiande.model.Order)pageContext.findAttribute("o");
                        int userId=o.getCustomerId();
                        java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
                        com.LuoXiande.dao.UserDao userDao=new com.LuoXiande.dao.UserDao();
                    ...
                    <td class="cart_total">${o.paymentId}
                        <%
                            ...
                            String paymentType=com.LuoXiande.model.Payment.findByPaymentId(con,n);
                        %>
